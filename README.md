...
- Tauri MCP-aware harness notes, not a working runner yet
- deterministic verdict language and evidence-first UI direction

The actual verification engine, persistence layer, and baseline registry are
still future work. This repo establishes the product shape and the initial UI.
